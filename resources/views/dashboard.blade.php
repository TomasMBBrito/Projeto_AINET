...
<div class="relative bg-green-100 h-[70vh] flex items-center justify-center text-center">
    <div class="absolute inset-0 bg-cover bg-center opacity-40" style="background-image: url('https://images.unsplash.com/photo-1613162300594-b1c104b91c49?auto=format&fit=crop&w=1950&q=80');"></div>
    <div class="relative z-10">
        ...
        <a href="{{ route('catalog.index') }}" class="btn px-6 py-3 bg-green-600 text-white hover:bg-green-700 rounded-full text-lg">
