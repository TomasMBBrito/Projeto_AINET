...
<div class="container mx-auto px-4 py-6">
    <h2 class="text-2xl font-bold text-green-700 mb-6">Confirm Purchase</h2>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form action="{{ route('cart.finalize') }}" method="POST" class="space-y-5">
            ...
            <div>
                <label for="delivery_address" class="block text-gray-700 font-medium mb-1">Delivery Address <span class="text-red-500">*</span></label>
